    ...
    public boolean handlePostContextMenu(final PostItem postItem, Replyable replyable, boolean allowMyMarkEdit,
        ...
        if (postItem != null) {
            ...
            if (!postItem.isDeleted()) {
                if (board.allowChangeRating) {
                    // Show change rating menu items.
                    dialogMenu.addItem(MENU_RATING_UP, R.string.action_rating_up);
                    dialogMenu.addItem(MENU_RATING_DOWN, R.string.action_rating_down);
                }
